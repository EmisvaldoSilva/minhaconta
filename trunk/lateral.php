...
<div class="menus">
	<ul id="navigation" class="filetree treeview">
		<?php 
			$principal = "<li class='closed'><span class='principal'><a href='". INDEX ."' title=''>Página Principal</a></span>\n";
			$principal .= "<ul>\n";
			...
			$principal .= "</li>\n";
			echo $principal;
			$lancamentos = "<li class='closed'><span class='lancamentos'><a href='". INDEX ."lancamentos/' title=''>Lançamentos</a></span>\n";
			$lancamentos .= "<ul>\n";
			$lancamentos .= "<li><span class='file'><a href='". INDEX ."lancamentos/depositar/'>Depositar</a></span></li>\n";
			...
			$lancamentos .= "</li>\n";
			echo $lancamentos;
			$programacao = "<li class='closed'><span class='programacao'><a href='". INDEX ."programacao/' title=''>Programação</a></span>\n";
			$programacao .= "<ul>\n";
			...
			$programacao .= "</li>\n";
			echo $programacao;
			$clientesfornecedores = "<li class='closed'><span class='cef'><a href='". INDEX ."clientes_fornecedores/' title=''>Clientes e Fornecedores</a></span>\n";
			...
			$categorias = "<li class='closed'><span class='categorias'><a href='". INDEX ."categorias/' title=''>Categorias</a></span>\n";
			$categorias .= "<ul>\n";
			...
			$categorias .= "</li>\n";
			echo $categorias;	
			$relatorios = "<li class='closed'><span class='ger'><a href='". INDEX ."graficos_relatorios/' title=''>Gráficos e Relatórios</a></span>\n";
			$relatorios .= "<ul>\n";
