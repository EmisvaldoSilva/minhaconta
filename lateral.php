...
<div class="menus">
	<ul id="navigation" class="filetree treeview">
		<?php 
			$principal = "<li class='closed'><span class='folder'><a href='#' title=''>Página Principal</a></span>\n";
			$principal .= "<ul>\n";
			...
			$principal .= "</li>\n";
			echo $principal;
			$lancamentos = "<li class='closed'><span class='folder'><a href='#' title=''>Lançamentos</a></span>\n";
			$lancamentos .= "<ul>\n";
			...
			$lancamentos .= "</li>\n";
			echo $lancamentos;
			$programacao = "<li class='closed'><span class='folder'><a href='#' title=''>Programação</a></span>\n";
			$programacao .= "<ul>\n";
			...
			$programacao .= "</li>\n";
			echo $programacao;
			$clientesfornecedores = "<li class='closed'><span class='folder'><a href='#' title=''>Clientes e Fornecedores</a></span>\n";
			...
			$categorias = "<li class='closed'><span class='folder'><a href='#' title=''>Categorias</a></span>\n";
			$categorias .= "<ul>\n";
			...
			$categorias .= "</li>\n";
			echo $categorias;	
			$relatorios = "<li class='closed'><span class='folder'><a href='#' title=''>Gráficos e Relatórios</a></span>\n";
			$relatorios .= "<ul>\n";
